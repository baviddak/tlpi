...
int main(int argc, char *argv[])
{
    ...
    addr.sun_family = AF_UNIX;						/* sun is not Sun Microsystems, it is socket - unix */
    strncpy(addr.sun_path, SV_SOCK_PATH, sizeof(addr.sun_path) - 1);	/* make sure that the last character is a \0 NULL */
