/* As noted in Section 20.3, sigaction() is more portable than signal() for establishing 
 * a signal handler. Replace the use of signal() by sigaction() in the program in 
 * Listing 20-7 (sig_receiver.c) 
 */
