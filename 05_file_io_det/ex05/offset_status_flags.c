...
/* Usage: offset_status_flags file.txt
 * file.txt is the name of the file which we will create a file descriptor for, 
 * then create a duplicate file descriptor from that. We can then confirm that 
 * those two file descriptrs have the same status flags and the same offset 
 */
